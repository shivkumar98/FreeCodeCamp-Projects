function convertToRoman(num) {
  ...
  let numberOf1000s = Math.floor(num/1000)
 if (num<=3){
   return "I".repeat(num)
 } else if (num==4){
   return "IV"
